const players = [
    { name: '--choose--', position: 'forward' },
    { name: 'Ronaldo', position: 'forward' },
    { name: 'Messi', position: 'forward' },
    { name: 'Neymar', position: 'forward' },
    { name: 'Mbappe', position: 'forward' },
    { name: 'Haaland', position: 'forward' },
    { name: 'Vinicius', position: 'forward' },
    { name: '--choose--', position: 'midfielder' },
